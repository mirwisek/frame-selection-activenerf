...
from utils.baseline_utils import select_frames_from_baseline, calculate_lpips, calculate_ssim, cluster_poses_by_kmeans, plot_images_as_grid
import argparse
import time
...
execution_time_file_path = f'{parent_dir}/{experiment_data_type}/execution_time.csv'
...
strategies = ["min_iou_3d", "camera_intrinsic", "random", "fvs"]
